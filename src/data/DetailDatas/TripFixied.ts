  ...
  myActivities: [
    {
      ...
      description:
        "애니메이션을 좋아하는 저는 페이지 전환 시 애니메이션을 적용해보자 라는 생각에 Framer-Motion 을 활용하여, 컴포넌트가 마운트 및 언마운트될 때 애니메이션을 적용하여, 리액트 생명주기를 시각적으로 확인할 수 있었습니다.",
    },
    {
  ...
  troubleShooting: [
    {
      ...
      serach: null,
      Resolution:
        "**[해결방안]** 첫 데이터 호출 시 모든 데이터를 가져와 이중 배열로 나누어 저장하고, 스크롤 이벤트 발생 시 index를 증가시키며 ,증가된 index를 참조하여 데이터를 출력 하도록 하여 API 호출 수를 약 90% 가량 감소시켰습니다",
      myThink: null,
    },
  ],
  ProjectIMG: [
