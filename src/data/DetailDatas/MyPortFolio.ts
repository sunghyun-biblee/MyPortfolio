  ...
  myActivities: [
    {
      ...
      description:
        "웹 페이지를 마크업할 때 시맨틱태그를 적극 활용하여, 가독성을 좋게 만들고, 검색엔진최적화(SEO)부분에서 이점을 가져오게합니다.\n또한 lightHouse를 참조하여 초기화면 로딩속도 FCP(0.9s), LCP(1.8s)를 차세대 이미지형식(webp)으로 변경하여 FCP(0.7s),LCP(1.3s)로 줄였습니다 ",
    },
    {
